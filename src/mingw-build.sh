#!/usr/bin/env bash
# mingw shit
LIBS="-static -lm -mwindows -lcfgmgr32 -lwinmm -lsetupapi -lshlwapi -lcomctl32 -U_WIN64 -fpermissive"
...
g++ -c esfm.c $LIBS -o esfm.o
g++ -c esfm_registers.c $LIBS -o esfm_registers.o
g++ -c essplaymid/esfm.c $LIBS -o esfm.o
g++ -c essplaymid/natv.c $LIBS -o natv.o
